...
function getSvgTextStyle(baseText) {
  let style = {};
  if (baseText.stroke) {
                ...
                CSS.Normalizations.registered[transformName] = function (
                  ...
                  switch (type) {
                    ...
                    case "inject":
                      ...
                      switch (
                        transformName.substr(0, transformName.length - 1)
                      ) {
                    ...
                    if (element === activeElement) {
                      ...
                      if (propertiesMap === "stop") {
                        ...
                        if (
                          ...
                          $.each(data.tweensContainer, function (
                            m,
                            activeTween
                          ) {
        ...
        function processElement(element, elementArrayIndex) {
          ...
          function buildQueue(next) {
            ...
            if (action === "scroll") {
              ...
              var parsePropertyValue = function (
                valueData,
                skipResolvingEasing
              ) {
...
function appearSlideDownInit(element) {
  return velocity(
    element,
    { top: `-${element.offsetHeight}px`, opacity: 0 },
    { duration: 0 }
  );
}
...
function appearSlideRightInit(element) {
  return velocity(
    element,
    { left: `-${element.offsetWidth}px`, opacity: 0 },
    { duration: 0 }
  );
}
...
function disappearSlideUp(element, delay, duration) {
  return velocity(
    element,
    {
      top: [
        `-${
          element.parentElement.offsetHeight * 0.05 + element.offsetHeight
        }px`,
        `${element.initTop}`,
      ],
      opacity: [1, 1],
...
function getDisappearAnimation(element, { name, startTime, duration }, Appear) {
  switch (name) {
    case "Slide Up":
      return disappearSlideUp(
        element,
        (startTime - Appear.startTime) * 1000,
        duration
      );
    case "Slide Down":
      return disappearSlideDown(
        element,
        (startTime - Appear.startTime) * 1000,
        duration
      );
    case "Slide Right":
      return disappearSlideRight(
        element,
        (startTime - Appear.startTime) * 1000,
        duration
      );
    case "Slide Left":
      return disappearSlideLeft(
        element,
        (startTime - Appear.startTime) * 1000,
        duration
      );
...
function addAnimation(Animation, element) {
  if (Animation) {
    ...
    if (Appear && Disappear) {
      ...
      return initAnimation(Animation, element).then(() => {
        return getAppearAnimation(element, Appear);
      });
...
class ClockTag {
  ...
  init(attr) {
    try {
      Object.assign(this, Object.assign({}, attr), {
        customMask: attr.customData.mask,
      });
    } catch (err) {
  ...
  render() {
    ...
    return h(
      "div",
      { class: "text-wrapper", style: getBaseTextStyle(this) },
      h(
        "svg",
        {
  ...
  static get style() {
    return "clock-tag{display:block;position:absolute;top:0;left:0;width:100%;height:100%;overflow:visible}clock-tag div{position:absolute;display:-ms-flexbox;display:flex}clock-tag div svg{width:100%;overflow:visible!important}";
  }
}
...
class ContentPlayerTag {
  ...
  static get style() {
    return "content-player-tag{display:block;width:100%;height:100%}content-player-tag div.content-player-wrapper{position:relative;width:100%;height:100%}content-player-tag .full-screen{display:block;position:static;margin:auto;width:100%;height:100%}";
  }
}
...
function renderContentImage(content) {
  if (content.type === "image") {
    ...
    return h(
      "div",
      { id: "image-wrappper", style: adjustment },
...
class ContentSlideTag {
  ...
  render() {
    return h(
      "div",
      { class: "content-slide-wrapper", style: { opacity: `${this.opacity}` } },
  ...
  static get style() {
    return "content-slide-tag{display:block;position:absolute;top:0;left:0}content-slide-tag,content-slide-tag .content-slide-wrapper{width:100%;height:100%}";
  }
}
...
class CustomContentTag {
  ...
  static get style() {
    return "custom-content-tag{display:block;width:100%;height:100%}custom-content-tag div.custom-content-container{position:relative;width:100%;height:100%}custom-content-tag .custom-content-image{position:absolute}";
  }
}
  ...
  render() {
    if (this.visible) {
      ...
      return h(
        ...
        h("img", { class: "progress-animation", src: base64GifImage }),
        h(
          "span",
          {
            class: "message",
...
class TextTag {
  ...
  static get style() {
    return "text-tag{display:block;position:absolute;top:0;left:0;width:100%;height:100%;overflow:visible}text-tag div{position:absolute;display:-ms-flexbox;display:flex}text-tag div svg{width:100%;height:100%;overflow:visible!important}";
  }
}
...
class WeatherTag {
  ...
  static get style() {
    return "weather-tag{display:block;position:absolute;top:0;left:0;width:100%;height:100%;overflow:visible}weather-tag div{position:absolute;display:-ms-flexbox;display:flex}weather-tag .weather-icon{position:relative;width:100%;height:100%}weather-tag div svg{width:100%;overflow:visible!important}";
  }
}
